package com.admin.baidumapdemo.officiallocationdemo;

import java.util.ArrayList;
import java.util.List;

import com.admin.baidumapdemo.R;
 ...
 * 说明：
 * 在BaseApplication中初始化实例LocationService、Vibrator（这样在整个应用中只初始化了1个location实例）；
 * 其他Activity中通过获取BaseApplication中的locationservice实例，然后使用。
 * @author baidu
 *
 */
public class OfficialLocationHomeActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_home_official_location);
		...
		FunctionList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				case 4://位置消息提醒
					...
					break;
				case 5://室内定位功能
					TargetClass = IndoorLocationActivity1.class;
					break;
				case 6://判断移动热点
                    TargetClass = IsHotWifiActivity.class;
					break;
				case 7://android 8.0后台定位示例
				...
				if (TargetClass != null) {
					Intent intent = new Intent(OfficialLocationHomeActivity.this, TargetClass);
